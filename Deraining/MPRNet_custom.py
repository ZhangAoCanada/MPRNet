...
class MPRNet(nn.Module):
    ...
    def forward(self, x3_img):
        ...
        # return [self.postProcess(stage3_img), self.postProcess(stage2_img), self.postProcess(stage1_img)]
        return self.postProcess(stage3_img)
